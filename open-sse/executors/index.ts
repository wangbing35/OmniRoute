...
// Temporarily disabled due to WASM module loading issues
...
const executors = {
  ...
  // tcw: new TinyCmsExecutor(), // Alias - Temporarily disabled due to WASM loading issues
...
// export { TinyCmsExecutor } from "./tinycms.ts"; // Temporarily disabled
